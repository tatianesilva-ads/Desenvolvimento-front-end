...
* **HTML5:** Estruturação semântica da página (`<div>`, `<ul>`, `<li>`, `<a>`, `<img>`, etc.).
...
```
<img width="489" height="639" alt="Image" src="https://github.com/user-attachments/assets/3f16f1b8-35ed-49eb-9b53-e765eb2e6836" />
